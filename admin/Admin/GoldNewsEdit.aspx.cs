...
public partial class Admin_GoldNewsEdit : System.Web.UI.Page
{
    public int id = 0;
    ...
    protected void btUp_Click(object sender, EventArgs e)
    {
        ...
        if (new StoredProcedure().C_ArticleOperate3(new string[] { id.ToString(),  
                Request.Form["txtTitle"],Request.Form["txtAbstract"], Request.Form["content"],Authority.GetNickName(Context)
