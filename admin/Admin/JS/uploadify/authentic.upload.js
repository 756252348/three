$(function () {
    ...
    o_upload.uploadify({
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            if (parseInt(json.fileId) < 1) {
                ...
                $("#viewImg").html("<img src='" + json.oImg + "' />");
                o_box.slideDown(1000).html("<img src='../album/" + o_upload_id.attr("data-file") + "/" + o_upload_id.attr("data-size") + "_" + o_upload_id.val() + "?r=" + Math.random() + "' />");
            }
        },
    ...
    if (o_upload_id.val().indexOf('.') > 0) {
        o_box.html("<img src='" + o_upload_id.attr("data-img") + "' />");
    }
})
