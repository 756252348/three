$(function () {
    ...
    o_upload.uploadify({
        ...
        onSelect: function (file) {
            o_upload.uploadify('settings', 'formData', { fieldID: 0, uType: 31, userId: cookie_user_id });
        },
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            if (parseInt(json.fileId) < 1) {
                ...
                $("#" + file.id).find(".uploadify-img").html("<img src='../album/" + json.s_Img + "' width='48' height='60' />");
