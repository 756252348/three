<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HowtoSpreadEdit.aspx.cs" Inherits="Admin_HowtoSpreadEdit" ValidateRequest="false" %>
            ...
            <table id="division" border="0" cellpadding="0" cellspacing="0" class="division">
               ...
               <%-- <tr>
                ...
                <tr>
                    <th>连接地址：</th>
                    <td>
                        <asp:TextBox ID="txtLink" CssClass="common-input" Width="99%" runat="server"  Text="#"></asp:TextBox>
                    </td>
                </tr>--%>
                <%--<tr>
                    <th>金矿图片：</th>
                    <td colspan="3" class="upload-box">
                        <ul>
                            <li><input type="button" id="uploadButton" value="浏览本地" /><em style="color:red;font-style:normal;">图像大小377*261</em></li>
                ...
                <tr>
                    ...
                    <td colspan="3" class="upload-box">
                        <ul>
                            <li><input type="button" id="uploadButton1" value="浏览本地" /></li>
