<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsInfoEdit.aspx.cs" Inherits="Admin_GoodsInfoEdit" ValidateRequest="false" %>
        ...
        <div class="Content">
            ...
            <table id="division" border="0" cellpadding="0" cellspacing="0" class="division">
                ...
                <tr>
                    <th>商品介绍：</th>
                    <td>
                        <asp:TextBox ID="intro" CssClass="common-input" runat="server" Width="99%" Height="48" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>外部图片：</th>
                    <td colspan="3" class="upload-box">
                        <ul>
                            <li><input type="button" id="uploadButton" value="浏览本地" /><em style="color:red;font-style:normal;">图像大小1080*527</em></li>
                ...
                <tr>
                    ...
                    <td colspan="3" class="upload-box">
                        <ul>
                            <li><input type="button" id="uploadButton1" value="浏览本地" /><em style="color:red;font-style:normal;">图像大小建议740*400;最多上传<b id="pCount3">1</b>张</em></li>
                            
                            <li><input type="hidden" id="ImgConfig1" runat="server" /><span class="red" id="Notice1"></span></li>
                        </ul>
                        <div style="clear: both; height: 5px; font-size: 100%">&nbsp;</div>
                        <div id="quee1">
                            <div class="imgGroup">
                        ...
                        <asp:HiddenField ID="txtAlbum1" runat="server" />
                    </td>
                </tr>
                <tr id="contentLine">
                    <th>图片详情：</th>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="rblIsShow" CssClass="RadioButtonListTable" Width="120" RepeatDirection="Horizontal" runat="server">
                            <asp:ListItem Value="2" >金额商品</asp:ListItem>
                            <asp:ListItem Value="1" >积分商品</asp:ListItem>
                            <asp:ListItem Value="0">锦囊商品</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <th>默认库存：</th>
                    <td>
                        <asp:TextBox ID="num" CssClass="common-input" runat="server" Width="99%"  TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    <th>商品价格：</th>
                    <td>
                        <asp:TextBox ID="price" CssClass="common-input" Width="99%" runat="server" Text=""></asp:TextBox>
                    </td>
                </tr>
