<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntroductionEdit.aspx.cs" Inherits="Admin_IntroductionEdit" %>
        ...
        <div class="Content">
            ...
            <table id="division" border="0" cellpadding="0" cellspacing="0" class="division">
                ...
                <%--<tr>
                    <th>简介标题：</th>
                    <td>
                        <asp:TextBox ID="txtTitle" CssClass="common-input nNull" runat="server" Width="99%" ></asp:TextBox>
                    </td>
                </tr>--%>
                <tr>
                    <th>简介内容：</th>
                    <td>
                        <asp:TextBox ID="TextBox1" CssClass="common-input nNull" runat="server" Width="99%" ></asp:TextBox>
                    </td>
                </tr>
                <%--<tr>
                    <th>普通信息摘要：</th>
